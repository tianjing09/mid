...
//        self.rightBgView.addGestureRecognizer(swipeGesture11)
    ...
    func freshStructure() {
        ...
        if (type == 1) {
            self.vcs = [TJRxRestartViewController(),TJRxDifficultViewController(),TJOneViewController(), TJTwoViewController(), TJThreeViewController(),TJSnapViewController(),TJRxSwiftViewController()]
            self.menus =
                   [["name":"rxRestart"],
